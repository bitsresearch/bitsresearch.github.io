...
self.addEventListener('fetch', event => {
  ...
  event.respondWith((async () => {
    if (!aesKey) {
      const accessUrl = scope.pathname;
      return new Response(
        '<!doctype html><meta name="robots" content="noindex"><title>Access required</title>' +
        '<p>Your training progress remains saved in this browser. ' +
        '<a href="' + accessUrl + '">Return to the access page</a> and enter the password to continue.</p>',
